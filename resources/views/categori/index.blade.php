  ...
  <div class="box">
    ...
    <div class="box-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            {{-- perulangan --}}
            @foreach ($categori as $item) {{-- cara menambahkan nomer dan pagination di laravel--}}
            <tr>
                {{-- cara memanggil adalah $item terus manggil nama dari table --}}
            <td>{{$loop->iteration}}</td>  {{-- cara menambahkan nomer dan pagination di laravel--}}
                <td>
                    {{$item->nama_kategori}}
                </td>
                <td>{{$item->slug}}</td>
