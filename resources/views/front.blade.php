...
@foreach ($categori as $item)
                        <li class="cat-1"><a href="{{ route('artikel.kategori',$item->slug)}}">{{$item->nama_kategori}}</a></li>
@endforeach               
</ul>
@endpush  <!-- Kasi end -->
@section('content')
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="post">
                            <a class="post-img" href="blog-post.html"><img src="{{asset('uploads/'.$all->gambar)}}"
                            ...
                            <div class="post-body">
                                ...
                                <h3 class="post-title"><a href="{{ route('artikel.detail',$all->judul) }}">
                                {{$all->judul}}
                                </a></h3>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                ...
                <div class="aside-widget">
                    ...
                    <div class="post post-widget">
                        ...
                        <div class="post-body">
                            <h3 class="post-title"><a href="{{ route('artikel.detail',$terkait->judul)}}">{{$terkait->judul}}</a></h3>
                        </div>
                    </div>
                    @endforeach
                </div>
