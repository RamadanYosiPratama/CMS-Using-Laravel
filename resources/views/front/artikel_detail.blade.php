                ...
                <div class="section-row sticky-container">
                    <div class="main-post">
                        ...
                        <figure class="figure-img">
                            <img class="img-responsive" src="{{asset('uploads/'.$artikel_detail->gambar) }}" alt="" width="600px" height="600px">
                ...
                <div class="aside-widget">
                    ...
                    <div class="category-widget">
                        ...
                        @foreach ($categori as $c)
                            <li><a href="{{ route('artikel.kategori',$c->slug)}}" class="cat-1">{{$c->nama_kategori}}<span>{{$c->artikel_count}}</span></a></li>
                        @endforeach
                        </ul>
